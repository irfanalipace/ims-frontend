...
import SecondCustomer from '../../views/pages/Customer/SecondCustomer/SecondCustomer.jsx';
import SecondNewCustomer from '../../views/pages/Customer/SecondCustomer/SecondNewCustomer.jsx';
...
export const routes = [
  ...
  {
    path: '/new/customer-new-table/view',
    page: (
      <ProtectedRoute>
        <PageWrapper isSidebar={true}>
       <SecondNewCustomer />
