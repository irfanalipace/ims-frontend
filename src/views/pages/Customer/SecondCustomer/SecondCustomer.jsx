...
import {   StyledListbox,
    ...
    HeaderMenuButton,
    StyledMenuItem,
    headerMenuBox } from '../CustomerStylesConst';
...
import ExportFileBody from '../../../Components/ExportFileModal/ExportFileBody';
              ...
              <Grid item xs={4} sx={{ textAlign: 'right' }}>
                {selectedRows.length > 0 ? (
                  ...
                  <Box>
                    <Button
                      size='medium'
                      onClick={() => navigate('/new/customer-new-table/view')}
                      variant='contained'
