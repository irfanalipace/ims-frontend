...
import TableAccordion from '../../../Components/TableAccordian/TableAccordian';
...
const ViewInvoice = () => {
  ...
  const calc = [
    { label: 'Subtotal:', value: `$${invoiceData?.sub_total || '0.00'}` },
    {
      key: 'discount',
      label: 'Discount:',
      value: `$${invoiceData?.discount_value?.toFixed(2) || '0.00'}`,
