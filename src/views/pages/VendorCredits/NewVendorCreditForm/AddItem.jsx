	...
	({
		...
		useEffect(() => {
			...
			if (venderCreditState?.discount_type !== null) {
				...
				// 	var discount =
				// 		(venderCreditState?.sub_total * venderCreditState?.discount_amount) / 100;
				...
				// 	discount_per_item = isEdit
				// 		? discountAmount / totle_item
				// 		: discount / totle_item;
				// } else if (venderCreditState?.discount_type === 'dollar') {
				// 	// } else if (venderCreditState?.discount_type === 'Dollar') {
				// 	discount_per_item = venderCreditState?.discount_amount / totle_item;
				// }
				discount_per_item = venderCreditState?.discount_amount / totle_item;
