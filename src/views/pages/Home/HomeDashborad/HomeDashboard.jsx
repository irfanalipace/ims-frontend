		...
		<Box>
			<Box sx={{ display: 'flex' }}>
				<Suspense>
					<MyCard
						...
						popoverText='Current and overdue amount that you are yet to receive from customers'
					/>
				</Suspense>
				<Box sx={{ marginLeft: '20px' }}>
					<Suspense>
						<MyCard
							...
							popoverText='Current and overdue amount that you are yet to pay your vendors'
						/>
					</Suspense>
				</Box>
			</Box>
			<Suspense>
				<Chart
					...
					cashAmount='0.00'
					inComing='Incoming'
					inComingAmount={cashObject.incoming}
					outGoing='Outgoing'
					outGoingAmount={cashObject.outgoing}
					cashLatestDate='Cash as on 23 Aug 2023'
					cashLatestAmmount='3,168,486.24'
					dataChart={cashObject.chart_data}
					onSave={onSave_CashFlow}
					popoverText='Amount of money moving in and out of your business.'
				/>
			</Suspense>
			<Box sx={{ display: 'flex' }}>
				<Suspense>
					<IncomeExpensiveChart
						...
						popoverText='Displays total sales, receipts, and expenses for the current year'
					/>
				</Suspense>
				<Suspense>
					<TopExpenses
						...
						popoverText='Displays top ten items '
					/>
				</Suspense>
				{/* <Box ml={1.5}>
