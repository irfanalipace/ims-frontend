...
import { Box, Grid, Paper, TextField, Divider } from '@mui/material';
...
const PriceQuoteForm = ({ edit }) => {
	...
	const initialValues_ = {
		...
		estimate_number: '',
		reference_number: '',
		estimate_date: formatDateToYYYYMMDD(new Date()),
	...
	const validationSchema = Yup.object().shape({
		...
		discount: Yup.number()
			...
			.test(
				'lessThanOrEqual',
				'Discount must be less then subTotal',
				function (value) {
	...
	useEffect(() => {
		formik.setFieldValue('expiry_date', formatDateToYYYYMMDD(new Date()));
	...
	const deleteFileFromApi = async fileId => {
		try {
			...
			console.log('deleteFileFromApi', error);
		}
	};
	...
	const fetchingSingleEstimate = async () => {
		try {
			...
			console.log('fetchingSingleEstimate', error);
		}
	};
